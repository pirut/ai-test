...
HOSTNAME_PREFIX="${SHOWROOM_HOSTNAME_PREFIX:-showroom}"
FIXED_HOSTNAME="${SHOWROOM_HOSTNAME:-}"
UNIQUE_HOSTNAME="${SHOWROOM_UNIQUE_HOSTNAME:-1}"
INITIAL_HOSTNAME="${FIXED_HOSTNAME:-${HOSTNAME_PREFIX}}"

cat > "${SHOWROOM_SYNC_DIR}/config/device.env" <<EOF
SHOWROOM_UNIQUE_HOSTNAME='${UNIQUE_HOSTNAME}'
SHOWROOM_HOSTNAME_PREFIX='${HOSTNAME_PREFIX}'
SHOWROOM_HOSTNAME_FIXED='${FIXED_HOSTNAME}'
EOF
...
TARGET_HOSTNAME='${INITIAL_HOSTNAME}'
