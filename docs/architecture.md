...
- Raspberry Pi device agent responsible for claim, sync, caching, screenshots, and command execution.
...
5. Devices cache assets locally before activating a new manifest.
