    ...
    <main className="landing">
      ...
      <aside className="landingCard">
        ...
        <ul>
          ...
          <li>Media library, playlists, and schedules</li>
          <li>Heartbeats, screenshots, and live commands</li>
          <li>Offline-capable playback from cached assets</li>
        </ul>
      </aside>
    </main>
  );
